...
public class MoteurdeMatching {
    ...
    public List<CoupleScore> dedupliquer(List<Nom> liste, double seuil) {
        ...
        // Log the number of pairs before selection
        ...
        // Log the number of pairs after selection
